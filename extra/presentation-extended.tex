...
\begin{frame}{What I will verify on paper}
\begin{columns}[T]
...
\small
\textbf{Write and check:}\par\medskip
...
\end{column}
\end{columns}
\source{Handwritten evidence remains pending until the student's real photo is supplied and the decks recompiled.}
\end{frame}
