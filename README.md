...
**Deliverables.** [Lean verification: 10 selected static results](lean/README.md); [Raw prompt/answer excerpts](prompts.md); [derivations and source map](extra/analysis.md); [oral script](extra/oral-notes.md); [build instructions](extra/README.md). **Still required:** your authentic handwritten photo in `hand/derivation.jpg`; both decks currently show an explicit pending panel. See [hand/](hand/README.md).
